...
First, we will create a new variable with synthetic data called `OstrichReproduction`, which indicates whether or not an ostrich laid an egg during totality.
