...
#Box plot comparing political party (x) and height (y) using ggplot function geom_boxplot(). The image is named politicalparty-height.png

```{r}
p5 <- mydata %>% ggplot(aes(x="Political Party", y=Height)) + geom_boxplot() 
plot(p5)
figure_file = here("starter-analysis-exercise","results","figures","politicalparty-height.png")
